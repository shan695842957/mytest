...
export const MENU_CONFIG: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'test-bms-level3-insight',
        label: 'test_bms_level3_insight',
        icon: <Battery className="size-4" />,
        path: '/test/bms-level3-insight',
        roles: [UserRole.DEVELOPER, UserRole.OPERATOR, UserRole.USER],
      },
      {
        key: 'test-bms-level2-insight',
        label: 'test_bms_level2_insight',
        icon: <Battery className="size-4" />,
        path: '/test/bms-level2-insight',
        roles: [UserRole.DEVELOPER, UserRole.OPERATOR, UserRole.USER],
      },
    ],
  },
