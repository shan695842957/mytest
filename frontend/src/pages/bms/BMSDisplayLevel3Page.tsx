...
import { BMSBauTabLevel3 } from '@/components/bms/BMSBauTabLevel3'
import { BMSBcuTabLevel3 } from '@/components/bms/BMSBcuTabLevel3'
import { BMSBmuTabLevel3 } from '@/components/bms/BMSBmuTabLevel3'
            ...
            <TabsContent value="bau" className="mt-4">
              {selectedBMSInstanceId ? (
                <BMSBauTabLevel3
                  ...
                  onFaultReset={() => {
                    // TODO: 实现故障复位API调用
                    console.log('Fault reset for stack')
                  }}
                />
              ) : (
                <Card>
            ...
            <TabsContent value="bcu" className="mt-4">
              {selectedBMSInstanceId ? (
                <BMSBcuTabLevel3
                  instanceId={selectedBMSInstanceId}
                  realtimeValues={realtimeValues}
                  onFaultReset={(clusterId) => {
                    // TODO: 实现故障复位API调用
                    console.log('Fault reset for cluster:', clusterId)
                  }}
                />
              ) : (
                <Card>
